...
const Card = () => {
    ...
    const Card = [
        {
            ...
            title: "Connect: Build a Global Network",
        ...
        },
        {
            ...
            title: "Collaborate: Join Forces for Success",
    ...
    return (
        <SectionWrapper>
            <div id="Card" className="custom-screen text-gray-600">
            <div className="max-w-3xl text-center mb-10 md:mx-auto">
                ...
                <ul className="grid gap-x-12 gap-y-12 sm:grid-cols-2 lg:grid-cols-3">
                    {
                        Card.map((item, idx) => (
                            <li key={idx} className="space-y-3">
                                <div className="w-12 h-12 border text-gray-500 rounded-full flex items-center justify-center">
                                    {item.icon}
                                </div>
